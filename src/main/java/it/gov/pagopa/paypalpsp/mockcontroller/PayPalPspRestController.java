...
public class PayPalPspRestController {
    ...
    public ResponseEntity<PpOnboardingBackResponse> homePage(@RequestHeader(value = "Authorization", required = false) String authorization,
        ...
        return ResponseEntity.ok(PpOnboardingBackResponse.builder().esito(PpOnboardingBackResponseCode.OK).urlToCall(UrlUtils.addQueryParams(returnUrl, "id_back", idBack)).build());
    }
    ...
    private ResponseEntity<PpOnboardingBackResponse> manageErrorResponseAlreadyOnboarded(TableUserPayPal tableUserPayPal) {
        ResponseEntity<PpOnboardingBackResponse> onboardingBackResponseResponseEntity = manageErrorResponse(PpOnboardingBackResponseErrCode.CODICE_CONTRATTO_PRESENTE);
    ...
    private ResponseEntity<PpOnboardingBackResponse> manageErrorResponse(PpOnboardingBackResponseErrCode errCode) {
        PpOnboardingBackResponse build = PpOnboardingBackResponse.builder().esito(PpOnboardingBackResponseCode.KO)
                .errCod(errCode)
